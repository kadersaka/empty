...
class InboxCategoriesContainer extends StatefulWidget {
  const InboxCategoriesContainer({super.key});

  @override
  State<StatefulWidget> createState() {
    return _InboxCategoriesContainerState();
  }
}

class _InboxCategoriesContainerState extends State<InboxCategoriesContainer> {
          ...
          child: Row(
            children: [
              ...[
                "Offer Graph",
                "Offers Received",
                "EventsCounter Offers Made",
                "Trades"
              ]
                  .map((e) => InboxCategory(
                        text: e,
                        isSelected: e == "Offers Received",
                      ))
                  .toList()
            ],
          ),
...
class InboxCategory extends StatelessWidget {
  final bool isSelected;
  final String text;
  const InboxCategory({super.key, this.isSelected = true, required this.text});
