...
class _NewHomePageState extends State<NewHomePage> {
  ...
  void initState() {
    ...
    closeFloatingActionButton  = const Icon(Icons.close, color: AppColors.PRIMARY_BRAND,);
...
*/
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    child: Row(
                      ...
                      children: [
                        !_separeted?
                        buildStackedImages(direction: TextDirection.rtl, xShift: -25)
                            :
                  ...
                  Align(
                    ...
                    child: Column(
                      ...
                      children: [
                        buildStackedImages(direction: TextDirection.ltr, isHorizontal: false, yShift: 20),
                        SizedBox(height: 50,),
                ...
                child: GestureDetector(
                  onTap: () {
                    if (spaceFromBottom! > 500) {
                      ...
                      if (_allMenuWidgets != null && _allMenuWidgets!.length > 1 &&  _allMenuWidgets!.length < 6) {
                        _fabMenuDialog();
                      }
                      else {
                  ...
                  child: Container(
                    ...
                    child: Image.asset("assets/images/yutu_logo_white.png",  fit: BoxFit.fill,),
                  ),
                ),
              ),
            ...
            children: <Widget>[
              ...
              SimpleDialogOption(
                ...
                child: Row(
                  ...
                  children: [
                    Image.asset("assets/images/p3-2.png", width: 25, height: 25,fit: BoxFit.fitWidth,),
                    SizedBox(width: 10,),
                    Text(
                        'General',
                      style: TextStyle(
  ...
  getItemPositions() {
    ...
    print('---------------------firstItemX: $firstItemX -------firstItemY: $firstItemY');
    print('---------------------secondItemX: $secondItemX -------secondItemY: $secondItemY');
    print('---------------------thirdItemX: $thirdItemX -------thirdItemY: $thirdItemY');
    print('---------------------fourthItemX: $fourthItemX -------fourthItemY: $fourthItemY');
    print('---------------------fifthItemX: $fifthItemX -------fifthItemY: $fifthItemY');
  }
